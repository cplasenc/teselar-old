...
export default function user() {
  ...
  if (error) router.push('/'); //si no existe usuario redirigue a portada
                  ...
                  >
                    ...
                    <div className='w-full p-2'>
                      <p className='mb-2 text-xs text-gray-500'>
                        ...
                        <Link href={`/t/${comment.post.subName}`}>
                          <a className='text-black cursor-pointer hover:underline'>
                            /t/{comment.post.subName}
                          </a>
                        </Link>
                      </p>
                      <hr />
          ...
          <div className='ml-6 w-80'>
            <div className='bg-white rounded'>
              ...
              <div className='p-3'>
                ...
                <hr />
                <p className='mt-2'>
                  Se unió el {dayjs(data.user.createdAt).format('MMM YYYY')}
                </p>
              </div>
            </div>
          </div>
